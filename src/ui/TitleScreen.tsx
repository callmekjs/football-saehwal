...
const STEPS = [
  ...
  },
  {
    n: '02',
    title: '75초 안에 손을 쓴다',
    body: '시계는 멈추지 않습니다. 고민하는 동안에도 상대는 공격하고 체력은 떨어집니다. 전술을 바꾸고 교체 카드를 꺼내되, 되돌릴 수는 없습니다.',
  },
  {
    n: '03',
    title: '경기 결과와 판단을 함께 확인한다',
    body: '한 경기의 승패만으로 판단의 좋고 나쁨을 단정할 수 없습니다. 경기가 끝나면 최종 점수와 함께, 같은 선택을 150번 비교한 결과를 보여드립니다.',
  },
] as const
      ...
      <main className="title-body">
        <section className="title-lead">
          ...
          <p className="title-tagline">
            축구 경기에는 한 번의 판단으로 승부가 갈리는 순간이 있습니다. 이미 벌어진
            상황 하나를 넘겨받아, 흐르는 경기 속에서 해법을 찾는 시뮬레이션입니다.
          </p>
